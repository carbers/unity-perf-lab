...
{
    public sealed class ListAddPerfCase : PerfCaseBase
    {
        ...
        public ListAddPerfCase(CollectionPayloadKind payloadKind, int workloadSize)
        {
            this.payloadKind = payloadKind;
            this.workloadSize = workloadSize;

            descriptor = new PerfCaseDescriptor(
                "List_" + CollectionPayloadFactory.GetPayloadLabel(payloadKind) + "_Add_" + FormatSizeLabel(workloadSize),
                "Collections",
